...
- **Code:** everything lives in [`frontend/`](frontend/) (Next.js)
...
| **Backend** | Database, API, staff login, hosting | [@ejluv143](https://github.com/ejluv143) |
| **Customer** | Guest QR ordering, order status, customer-facing display | [@Krismar-Gonzaga](https://github.com/Krismar-Gonzaga) |
...
### Sprint 1: Mon Sep 28 – Fri Oct 9, 2026

@ejluv143 builds the backend first (days 1–5), because the cashier, kitchen, customer and inventory screens all need the shared database and API. Until then, Krismar works on the kitchen and customer screens using the browser-saved data the app already has.

| Day | Date | @ejluv143 | @Krismar-Gonzaga |
|---|---|---|---|
| 1 | Mon, Sep 28 | [#1](https://github.com/ejluv143/Restaurant-POS/issues/1) Backend: Set up the database and project config | [#2](https://github.com/ejluv143/Restaurant-POS/issues/2) Kitchen: Kitchen Display shows real tickets |
| 2 | Tue, Sep 29 | [#3](https://github.com/ejluv143/Restaurant-POS/issues/3) Backend: Database schema and seed data | [#4](https://github.com/ejluv143/Restaurant-POS/issues/4) Kitchen: Stations, timers and bumping |
| 3 | Wed, Sep 30 | [#5](https://github.com/ejluv143/Restaurant-POS/issues/5) Backend: Tables & bills API | [#6](https://github.com/ejluv143/Restaurant-POS/issues/6) Kitchen: Room-service orders on the KDS |
| 4 | Thu, Oct 1 | [#7](https://github.com/ejluv143/Restaurant-POS/issues/7) Backend: Hosting with a server + room orders in the database | [#8](https://github.com/ejluv143/Restaurant-POS/issues/8) Customer: Table QR ordering for restaurant tables |
